...
Future<String> getImage() async {
  ...
  final newImageUrl = 'https://91dc-223-186-69-228.ngrok-free.app/show_generated_image?timestamp=${DateTime.now().millisecondsSinceEpoch}'; //wsl2 laptop
  return newImageUrl;
}
...
Future<String?> generateImage(String text, String lang) async {
  try {
    ...
    var response = await http.post(
      ...
      Uri.parse('https://91dc-223-186-69-228.ngrok-free.app/generate_image/'), //wsl2 laptop
